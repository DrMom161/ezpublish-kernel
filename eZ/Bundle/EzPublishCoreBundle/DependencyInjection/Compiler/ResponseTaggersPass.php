...
class ResponseTaggersPass implements CompilerPassInterface
{
    ...
    {
        if (!$container->hasDefinition('ezplatform.http_cache.response_tagger.dispatcher')) {
            return;
        }
        ...
        $dispatcher = $container->getDefinition('ezplatform.http_cache.response_tagger.dispatcher');
