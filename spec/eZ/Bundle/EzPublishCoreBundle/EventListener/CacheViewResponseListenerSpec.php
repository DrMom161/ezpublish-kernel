...
class CacheViewResponseListenerSpec extends ObjectBehavior
{
    ...
    public function it_does_not_enable_cache_if_the_view_is_not_cachable(
        FilterResponseEvent $event,
    ...
    public function it_does_not_enable_cache_if_view_cache_is_disabled(
        FilterResponseEvent $event,
        ResponseCacheConfigurator $configurator,
        CachableView $view,
        ParameterBag $requestAttributes,
    ...
    public function it_enables_cache_if_enabled(
        FilterResponseEvent $event,
        ResponseCacheConfigurator $configurator,
        CachableView $view,
        ParameterBag $requestAttributes,
    ...
    public function it_sets_shared_maxage_if_enabled(
        FilterResponseEvent $event,
        ResponseCacheConfigurator $configurator,
        CachableView $view,
        ParameterBag $requestAttributes,
    ...
    public function it_delegates_tagging_to_the_dispatcher_tagger(
        FilterResponseEvent $event,
        ResponseCacheConfigurator $configurator,
        CachableView $view,
        ParameterBag $requestAttributes,
